...
int main() {
...

    {
        ...
        for (auto typ :
             {memvanta::KVCacheType::F32, memvanta::KVCacheType::F16, memvanta::KVCacheType::Q8}) {
...

    {
        ...
        CHECK_MSG(second_run_threw,
                  "Runtime silently allowed a second run after stopping prefetch");
        std::remove(path);
    }
